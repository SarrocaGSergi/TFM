...
def select_dataset(dataset_name, data_root, transform, dictionary, workers=1, batch_size=64):
    if dataset_name == "fashion_mnist":
        ...
        dataset = FashionGen(train_root=data_root, transform=transform, dictionary=dictionary)
...
def gradient_penalty(discriminator, real_batch, fake_batch, labels, device='cpu'):
