...
OUT_PATH = directory + network +"_rms" + "/" + dataset_name + "/" + f"{num_epochs}" + "/" + opt + "/" + f"{batch_size}" + "/" + f"{learning_rate}"
GEN_WEIGHTS = directory + network +"_rms" + "/" + dataset_name + "/" + f"{num_epochs}" + "/" + opt + "/" + f"{batch_size}" + "/" + f"{learning_rate}+/gen_weights"
DISC_WEIGHTS = directory + network +"_rms" + "/" + dataset_name + "/" + f"{num_epochs}" + "/" + opt + "/" + f"{batch_size}" + "/" + f"{learning_rate}+/disc_weights"
