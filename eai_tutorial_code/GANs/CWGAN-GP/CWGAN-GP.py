...
for bs in batch_size:
    ...
    for lr in learning_rates:
        ...
        writer = SummaryWriter(directory + net + "test/" + dataset_name + "/" + f"{num_epochs}" + "/" + opt + "/" + f"{bs}" + "/" + f"{lr}")
        ...
        for epoch in range(num_epochs):
            ...
            for i, data in enumerate(dataloader, 0):
                ...
                for _ in range(critic_iter):
                    ...
                    # WLoss function + WGP
                    gp = gradient_penalty(discriminator=netD, labels=y, real_batch=real_cpu, fake_batch=fake, device=device)
